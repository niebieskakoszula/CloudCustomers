...
namespace CloudCustomers.UnitTests.Systems.Services
{
	public class TestUsersService
	{
		...
		static string endpoint = "http://example.com/users";
		static List<User> expectedResponse = UsersFixture.GetTestUsers();
		static IOptions<UsersApiOptions> config = Options.Create(
				new UsersApiOptions
				{
